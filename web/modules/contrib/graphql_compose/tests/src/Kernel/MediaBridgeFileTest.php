 ...
 *
 * @coversDefaultClass \Drupal\graphql_compose\Plugin\GraphQL\DataProducer\MediaBridge
 * @group MediaBridge
...
class MediaBridgeFileTest extends FieldKernelTestBase {
  ...
  public function testImageField() {
    ...
    /** @var \Drupal\graphql_compose\Plugin\GraphQL\DataProducer\MediaBridge $data_producer */
