...
use Drupal\graphql_compose\GraphQL\Payload\RelayMutationPayloadInterface;
...
class PayloadClientMutationId extends DataProducerPluginBase implements DataProducerPluginCachingInterface {
   ...
   *
   * @param \Drupal\graphql_compose\GraphQL\Payload\RelayMutationPayloadInterface $payload
