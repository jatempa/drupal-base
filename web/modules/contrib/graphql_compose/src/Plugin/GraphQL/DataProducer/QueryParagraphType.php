...
use Drupal\graphql_compose\GraphQL\QueryHelper\ParagraphTypeQueryHelper;

/**
 * Queries ParagraphType Nodes on the platform.
 *
 * @DataProducer(
 *   id = "query_paragraph_type",
 ...
 *     ),
 *   },
 *  deriver = "Drupal\graphql_compose\Plugin\Derivative\QueryParagraphTypeDataProducer"
 * )
 */
class QueryParagraphType extends EntityDataProducerPluginBase {
  ...
  public function resolve(?int $first, ?string $after, ?int $last, ?string $before, bool $reverse, string $sortKey, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query_helper = new ParagraphTypeQueryHelper(
      $sortKey,
