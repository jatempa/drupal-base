...
use Drupal\graphql_compose\GraphQL\QueryHelper\MediaTypeQueryHelper;

/**
 * Queries MediaType Nodes on the platform.
 *
 * @DataProducer(
 *   id = "query_media_type",
 ...
 *     ),
 *   },
 *   deriver = "Drupal\graphql_compose\Plugin\Derivative\QueryMediaTypeDataProducer"
 * )
 */
class QueryMediaType extends EntityDataProducerPluginBase {
  ...
  public function resolve(?int $first, ?string $after, ?int $last, ?string $before, bool $reverse, string $sortKey, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query_helper = new MediaTypeQueryHelper(
      $sortKey,
