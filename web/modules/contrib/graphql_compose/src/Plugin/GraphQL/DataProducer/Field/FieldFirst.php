 ...
 * )
 */
class FieldFirst extends DataProducerPluginBase {
   ...
   */
  public function resolve(EntityInterface $entity, string $field): ?EntityInterface {
    ...
    // Extending original `field` plugin as `field_first` to return first element.
    if (!$value) {
      return NULL;
    }
