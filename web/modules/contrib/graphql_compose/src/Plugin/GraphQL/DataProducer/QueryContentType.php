...
use Drupal\graphql_compose\GraphQL\QueryHelper\ContentTypeQueryHelper;

/**
 * Queries ContentType Nodes on the platform.
 *
 * @DataProducer(
 *   id = "query_content_type",
 ...
 *     ),
 *   },
 *   deriver = "Drupal\graphql_compose\Plugin\Derivative\QueryContentTypeDataProducer"
 * )
 */
class QueryContentType extends EntityDataProducerPluginBase {
  ...
  public function resolve(?int $first, ?string $after, ?int $last, ?string $before, bool $reverse, string $sortKey, RefinableCacheableDependencyInterface $metadata) {
    ...
    $query_helper = new ContentTypeQueryHelper(
      $sortKey,
